        ...
        <section className="relative h-screen ">
          ...
          <div className="relative z-10 flex justify-center items-center flex-col px-4 mx-auto max-w-5xl">
            ...
            <p className="mt-60 text-[20px] md:text-[24px] text-[#1E1E1E] text-center px-4">
              ...
              natural fibers from their pure sources, and we believed that
              purity is not just a characteristic, but a commitment that begins
              with the supplier and ends in your hands.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 w-[80%]">
              ...
              <p className="text-[20px] md:text-[22px] text-stone-600 mb-4">
                ...
                the apparel brand, where nature's bounty is both a treasure and
                a responsibility. We feel blessed to be surrounded by such
                natural beauty. However, we often witness the tension between
                the woman who depends on the sea for their livelihood and the
                need to preserve its delicate ecosystems. Whether or not they
                mention one of the earth.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[20px] md:text-[22px] text-stone-600 mb-4">
                ...
                impact on the world around us. By choosing sustainable, we are
                not just buying clothes. We are making a statement about the
                kind of world we want to live in and the legacy we want to leave
                behind.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-[20px] md:text-[22px] text-stone-600 mb-4 w-[90%]">
                Table lace pride in sourcing materials and producing garments
                that are not only beautiful but also ethically made. From the
                luxurious Irish lace to the sustainable fabrics we choose, every
                element in our collection reflects our commitment to
                environmental responsibility. Each piece is created with love
                and care, ensuring that it not only looks beautiful but also
                feels good to wear. We are dedicated and transparent in sourcing
                and established process is tailored to those who value luxury as
                much as they value the planet. By prioritizing sustainability,
                we aim to set a new standard in the fashion industry that proves
                that style and environmental consciousness can coexist
                harmoniously. We also hope, for also making and raising
                awareness to every layer that with our production process, is
                made of their resources wisely, and contribute better future for
                generations to come.
              </p>
            </div>
            <div className="relative flex justify-end w-fit order-1 md:order-1">
