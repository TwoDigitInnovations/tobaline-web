    ...
    <div className="min-h-screen bg-white text-black px-6 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-md mb-8 leading-relaxed">
          We want you to be completely satisfied with your purchase. This Return
          & Exchange Policy explains the conditions under which returns and
        ...
        <section className="mb-8">
          ...
          <p className="text-md leading-relaxed">
            ...
            packaging, and returned within the specified return period from the
            date of delivery.
          </p>
        </section>
