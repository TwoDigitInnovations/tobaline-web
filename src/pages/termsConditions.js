    ...
    <div className="min-h-screen bg-white text-black px-6 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-md leading-relaxed">
            All content, designs, logos, text, graphics, and other materials on
            this website are owned by us and are protected by applicable
        ...
        <section className="mb-8">
          ...
          <p className="text-md leading-relaxed">
            ...
            use of the website after changes indicates your acceptance of the
            updated terms.
          </p>
        </section>
